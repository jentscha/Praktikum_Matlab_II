...
\begin{figure}[htbp]
	...
	\caption{Systemverhalten mit Beobachtereigendwerten bei: [-1 -1 -5 -5]}
	\label{fig:beob1}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Systemverhalten mit Beobachtereigendwerten bei: [-5 -5 -10 -10]}
	\label{fig:beob2}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Systemverhalten mit Beobachtereigendwerten bei: [-10 -10 -20 -20]}
	\label{fig:beob3}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Systemverhalten mit Beobachtereigendwerten bei: [-20 -20 -40 -40]}
	\label{fig:beob4}
\end{figure}
\newpage
