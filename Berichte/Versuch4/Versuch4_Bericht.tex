...
Nachfolgend sind Verläufe abgebildet, um den Einfluss von verschiedenen Beobachtereigenwerten darzustellen. Dabei sind die Verläufe der geschätzten Zuständen in jedem Plot zusammen mit den realen dargestellt.
\begin{figure}[htbp]
	\centering
